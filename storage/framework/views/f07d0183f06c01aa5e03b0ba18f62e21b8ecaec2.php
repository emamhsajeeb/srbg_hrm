                    ...
                    <div class="card em-card" style="height: 506px">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('nid_bc', __('NID/Birth Certificate No.'), ['class' => 'form-label']); ?><span class="text-danger pl-1">*</span>
                                    <?php echo Form::text('nid_bc', null, ['class' => 'form-control', 'required' => 'required']); ?>
                    ...
                    <div class="card em-card " style="height: 506px">
                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <?php echo Form::label('bank_identifier_code', __('Bank Routing Number'), ['class' => 'form-label']); ?>

                                    <?php echo Form::text('bank_identifier_code', old('bank_identifier_code'), ['class' => 'form-control' ,'placeholder'=>'Enter Bank Routing Number']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magpfymo/srbg.pro/resources/views/employee/create.blade.php ENDPATH**/ ?>