            ...
            <div class="col-sm-12 col-md-6">
                    ...
                    <h5><?php echo e(__('Bank Account Detail')); ?></h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info text-sm">
                                    <strong class="font-bold"><?php echo e(__('Bank Routing Number')); ?> :</strong>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/magpfymo/srbg.pro/resources/views/employee/show.blade.php ENDPATH**/ ?>