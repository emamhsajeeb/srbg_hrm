                    ...
                    <div class="card em-card" style="height: 506px">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    {!! Form::label('nid_bc', __('NID/Birth Certificate No.'), ['class' => 'form-label']) !!}<span class="text-danger pl-1">*</span>
                                    {!! Form::text('nid_bc', null, ['class' => 'form-control', 'required' => 'required']) !!}
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="card em-card " style="height: 506px">
                        ...
                        <div class="card-body employee-detail-create-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    {!! Form::label('bank_identifier_code', __('Bank Routing Number'), ['class' => 'form-label']) !!}
                                    {!! Form::text('bank_identifier_code', old('bank_identifier_code'), ['class' => 'form-control' ,'placeholder'=>'Enter Bank Routing Number']) !!}
                                </div>
                                <div class="form-group col-md-6">
